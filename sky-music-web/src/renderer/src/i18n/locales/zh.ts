export default {
  ...
  shortcutKeys: {
	...
	magic_tools: {
		...
		patterns: ["谨慎使用🌶", "不涉及内存修改🌶", "此处功能仅供学习交流，严禁用于商业用途，请于24小时内删除", "🚫模拟器玩家禁止使用下面的所有功能🚫"],
		buttons: {
			check: "检查",
			abaaba: "狠狠的叫",
			heart_fire: "心火",
	...
	hwnd_handle: {
		...
		patterns: ["更改后台发送的目标", "光遇", "未测试", "不会", "不要找我", "导致", "封号", "反作弊机制"],
		refresh: "刷新列表",
		reset_sky: "重置为光遇窗口",
		now_hwnd: "现在的句柄 >",
		columns: {
